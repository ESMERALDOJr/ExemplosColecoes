...
namespace Colecoes // Note: actual namespace depends on the project name.
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // var numerosParesQuery =   //sintaxe de Query
            //         from num in arrayNumeros
            //         where num % 2 == 0 
            //         orderby num 
            //         select num;

            // var numerosParesMetodos = arrayNumeros.Where(x => x % 2 == 0).OrderBy(x => x).ToList(); //sintaxe de Metodos

            // System.Console.WriteLine("Números pares query: " + string.Join(", ", numerosParesQuery));
            // System.Console.WriteLine("Números pares métodos: " + string.Join(", ", numerosParesMetodos));
            ...
            // {
            //     System.Console.WriteLine($"Próximo livro para a leirtura: {pilhaLivros.Peek()}");
            ...
            // else
            // {
            //     System.Console.WriteLine("Existem valores que não são miores do que {0}", valorProcurado);
            // }
